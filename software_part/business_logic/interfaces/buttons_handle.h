...
/**
 * @brief Зчитати стан кнопок
 * 
 * Виконує зчитування стану кнопок через ADC та декодування
 * аналогового значення в ідентифікатор кнопки.
 * 
 ...
 * 
 * @note Функція виконує блокуюче зчитування ADC.
 *       Час виконання: ~100 мкс при 16 МГц
 * 
 * @warning ADC має бути попередньо ініціалізований
 *          викликом initialize_buttons()
 * 
 * 
 * @see ButtonID
 * @see initialize_buttons()
 */
